...
int main(int argc, char* argv[]){
    ...
    */
    ...
    if(out == NULL){
        ...
        fprintf(out, "Name, Type, #Elem, Method, BinPerc, Size, Construction Time, Mean Construction Time, Query Time, Mean Query Time, Mean Query Time PGM Structure, Mean Query Time Data Structure\n");
    }else{
        fclose(out);
